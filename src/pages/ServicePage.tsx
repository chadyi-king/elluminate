...
const ServicePage = () => {
  ...
  const serviceSEO: Record<string, { title: string; description: string; canonical: string }> = {
    ...
    "amazing-race": { title: "Amazing Race Team Building Singapore | Elluminate", description: "Plan a facilitated Amazing Race team-building activity in Singapore around your group size, route, timing, objectives, and wet-weather considerations.", canonical: "https://elluminate.sg/services/amazing-race" },
    ...
    "csi-bones": { title: "CSI Team Building Singapore | Elluminate", description: "Plan a CSI-style team-building investigation in Singapore where teams examine clues, discuss theories, and work together to solve the case.", canonical: "https://elluminate.sg/services/csi-bones" },
    "monopoly-dash": { title: "Monopoly Dash Team Building Singapore | Elluminate", description: "Plan a Monopoly-inspired team-building activity in Singapore combining movement, strategy, team decisions, points, and friendly competition.", canonical: "https://elluminate.sg/services/monopoly-dash" },
    ...
    "minute-to-win-it": { title: "Minute to Win It Singapore | Team Building Game | Elluminate", description: "Plan a facilitated Minute to Win It team-building programme in Singapore with short challenges, team rotations, and an adaptable indoor event flow.", canonical: "https://elluminate.sg/services/minute-to-win-it" },
    ...
    // Retreats
    "overseas-retreats": { title: "Overseas Corporate Retreat Singapore | Elluminate", description: "Plan an overseas corporate retreat from Singapore around your destination, team objectives, itinerary, activities, accommodation, and event logistics.", canonical: "https://elluminate.sg/services/overseas-retreats" },
    "local-retreats": { title: "Local Corporate Retreat Singapore | Elluminate", description: "Plan a local corporate retreat in Singapore around your team objectives, venue, agenda, activities, meals, accommodation, and event logistics.", canonical: "https://elluminate.sg/services/local-retreats" },
    ...
    // Training
    "mbti": { title: "MBTI Workshop Singapore | Elluminate", description: "Plan an MBTI personality profiling workshop for corporate teams in Singapore, with a structured session focused on communication and working preferences.", canonical: "https://elluminate.sg/services/mbti" },
    ...
    "workshops": { title: "Corporate Workshops Singapore | Elluminate", description: "Plan a corporate workshop in Singapore around your audience, learning objective, session length, delivery format, and wider company event agenda.", canonical: "https://elluminate.sg/services/workshops" },
