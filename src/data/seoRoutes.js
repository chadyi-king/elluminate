...
const routeSeoBase = [
  ...
  { path: "/services/retreats", family: "retreats", searchIntent: "Company retreats and corporate retreats", h1: "Company Retreats Your People Will Still Talk About", title: "Company Retreats and Offsites Singapore | Elluminate", description: "Plan local or overseas company retreats around your team, objectives, dates, travel needs and programme. Compare retreat directions with Elluminate." },
  { path: "/services/training", family: "training", searchIntent: "Corporate training, workshops and team profiling", h1: "Training Your People Can Actually Use", title: "Corporate Training and Workshops Singapore | Elluminate", description: "Plan corporate training, workshops and team profiling around your audience, workplace challenge, timing and learning objective with Elluminate Singapore." },
