...
export const servicesData: Record<string, ServiceData> = {
  ...
  "amongst-us": {
    ...
    hero: {
      ...
      tagline: "A live social-deduction showdown where teams hunt imposters, protect their crew, and outplay each other under pressure.",
      backgroundImage: heroTeamCelebration,
    },
    overview: {
      description: "Amongst Us brings the social-deduction format into a live, fully facilitated team-building experience. Participants move through missions, suspicion rounds, secret roles, and timed reveals while trying to complete objectives without letting the imposters sabotage the team. It works especially well for workplaces, student leaders, camps, and mixed groups because the format rewards observation, persuasion, teamwork, and a good sense of humour rather than fitness alone.",
      backgroundImage: heroTeamCelebration,
    },
    features: [
  ...
  "alice-in-motherland": {
    ...
    hero: {
      ...
      subtitle: "Physical Team Building",
      tagline: "A whimsical story adventure filled with themed missions, curious puzzles, and shared moments that pull teams into a world of playful chaos.",
      backgroundImage: heroCreativeWorkshop,
    },
    overview: {
      description: "Alice in Motherland is an immersive team-building adventure built around storytelling, playful world-building, and light challenge design. Teams journey through themed stations, complete curious missions, solve imaginative puzzles, and collaborate their way through a surreal experience that feels more cinematic than standard team bonding. It works especially well for clients or schools looking for something memorable, creative, and visually distinctive.",
      backgroundImage: heroCreativeWorkshop,
    },
    features: [
