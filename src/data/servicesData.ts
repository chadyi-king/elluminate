...
export const servicesData: Record<string, ServiceData> = {
  ...
  "leadership-offsites": {
    ...
    howItWorksFlow: {
      sectionTitle: "WHAT TO EXPECT",
      sectionSubtitle: "The Offsite Journey",
      itemsPerRow: 3,
      showNumbers: true,
      items: [
  ...
  "wellness-events": {
    ...
    howItWorksFlow: {
      sectionTitle: "WHAT TO EXPECT",
      sectionSubtitle: "The Wellness Day Experience",
      itemsPerRow: 3,
      showNumbers: true,
      items: [
    ...
    recentEvents: [
      { client: "Google Singapore", event: "Team Wellness Day", pax: 120 },
      { client: "DBS Bank", event: "Staff Appreciation Wellness", pax: 280 },
      { client: "Unilever Singapore", event: "Mental Health Day", pax: 195 },
      { client: "Shopee Singapore", event: "Wellness Wednesday Series", pax: 340 },
      { client: "Deloitte Singapore", event: "Year-End Wind Down", pax: 160 },
      { client: "Marina Bay Sands", event: "Employee Wellness Fair", pax: 420 },
      { client: "OCBC Bank", event: "Fitness & Mindfulness Day", pax: 250 },
      { client: "Ministry of Health", event: "Staff Wellness Programme", pax: 310 },
      { client: "NUS Singapore", event: "Faculty Wellness Retreat", pax: 85 },
      { client: "Singtel", event: "Wellness Team Day", pax: 175 },
    ],
    recentEventsHeadline: "Companies who've invested in Wellness Events",
    pricing: { startingPrice: "$120", unit: "per pax", minimumPax: 15, duration: "3-6 hours", activityType: "hybrid" },
    packages: [
      {
        color: "#26D07C",
        title: "Wellness Lite",
