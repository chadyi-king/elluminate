...
export const servicesData: Record<string, ServiceData> = {
  ...
  "csi-bones": {
    ...
    packages: trafficLightPackages("From $60/pax", "CSI-Bones", "#26D07C"),
  ...
  "cultural-race": {
    ...
    packages: trafficLightPackages("From $60/pax", "Cultural Race", "#FF4F4F"),
    addOns: defaultAddOns,
    miniGallery: {
  ...
  "archery-tag": {
    ...
    pricing: { startingPrice: "From $60", unit: "per pax", minimumPax: 20, duration: "2-3 hours", activityType: "outdoor" },
    packages: trafficLightPackages("From $60/pax", "Archery Tag", "#2A8DFF"),
    addOns: defaultAddOns,
    miniGallery: {
  ...
  "builder-cross": {
    ...
    pricing: { startingPrice: "From $60", unit: "per pax", minimumPax: 20, duration: "2-3 hours", activityType: "indoor" },
    packages: trafficLightPackages("From $60/pax", "Builder Cross", "#FFC400"),
    addOns: defaultAddOns,
  ...
  "gel-blitz": {
    ...
    pricing: { startingPrice: "From $60", unit: "per pax", minimumPax: 20, duration: "2-3 hours", activityType: "outdoor" },
    packages: trafficLightPackages("From $60/pax", "GelBlitz", "#2A8DFF"),
    addOns: defaultAddOns,
  ...
  "minute-to-win-it": {
    ...
    pricing: { startingPrice: "From $60", unit: "per pax", minimumPax: 20, duration: "2-3 hours", activityType: "indoor" },
    packages: trafficLightPackages("From $60/pax", "Minute To Win It", "#FF8A3D"),
    addOns: defaultAddOns,
  ...
  "monopoly-dash": {
    ...
    pricing: { startingPrice: "From $60", unit: "per pax", minimumPax: 20, duration: "2-3 hours", activityType: "outdoor" },
    packages: trafficLightPackages("From $60/pax", "Monopoly Dash", "#FFC400"),
    addOns: defaultAddOns,
  ...
  "nerfwar": {
    ...
    pricing: { startingPrice: "From $60", unit: "per pax", minimumPax: 20, duration: "2-3 hours", activityType: "indoor" },
    packages: trafficLightPackages("From $60/pax", "Nerfwar", "#FFC400"),
    addOns: defaultAddOns,
  ...
  "running-man": {
    ...
    pricing: { startingPrice: "From $60", unit: "per pax", minimumPax: 20, duration: "2-3 hours", activityType: "hybrid" },
    packages: trafficLightPackages("From $60/pax", "Running Man Adventure", "#FF4F4F"),
    addOns: defaultAddOns,
  ...
  "sotong-game": {
    ...
    pricing: { startingPrice: "From $60", unit: "per pax", minimumPax: 20, duration: "2-3 hours", activityType: "indoor" },
    packages: trafficLightPackages("From $60/pax", "Sotong Game", "#D946EF"),
    addOns: defaultAddOns,
  ...
  "tag-tical-laser-teambuilding": {
    ...
    pricing: { startingPrice: "From $60", unit: "per pax", minimumPax: 20, duration: "2-3 hours", activityType: "indoor" },
    packages: trafficLightPackages("From $60/pax", "Tag-tical Laser Teambuilding", "#FFC400"),
    addOns: defaultAddOns,
  ...
  "treasure-heist": {
    ...
    pricing: { startingPrice: "From $60", unit: "per pax", minimumPax: 10, duration: "2-3 hours", activityType: "outdoor" },
