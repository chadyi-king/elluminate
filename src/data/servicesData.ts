...
export const servicesData: Record<string, ServiceData> = {
  ...
  "csi-bones": {
    ...
    testimonials: [
      ...
      { quote: "Our team was cracking jokes and trading theories right till the final reveal. Perfect balance of silly and sharp.", author: "People Manager", company: "Shopee Singapore" },
      { quote: "CSI-Bones worked well across a mixed group. Even the non-competitive folks were invested by the second clue.", author: "Learning & Development", company: "Prudential Singapore" },
      { quote: "The cast of suspects and the physical evidence made it feel real. One of the most memorable sessions we have done.", author: "Department Head", company: "NTU Singapore" },
    ],
    faqs: [],
    cta: {
    ...
    outcomes: [
      ...
      { icon: "TrendingUp", title: "Improved Cross-Team Trust", description: "Solving puzzles together builds mutual reliability that carries back into day-to-day work." },
      { icon: "Award", title: "Earned Group Pride", description: "Successfully cracking the case gives the team a moment of genuine collective achievement." },
    ],
    miniGallery: {
  ...
  "cultural-race": {
    ...
    testimonials: [
      ...
      { quote: "Cultural Race moved us through parts of Singapore most of us had never actually stopped to explore. Really well designed.", author: "Programme Manager", company: "DBS Bank" },
      { quote: "A surprisingly meaningful experience. The local discovery moments stuck with the team far longer than a typical activity.", author: "Employee Experience Lead", company: "Grab Singapore" },
      { quote: "Our school cohort loved the combination of movement, teamwork, and local culture. Already planning the next one.", author: "Teacher", company: "Anglo-Chinese School" },
    ],
    faqs: [],
    cta: {
    ...
    outcomes: [
      ...
      { icon: "TrendingUp", title: "Greater Cultural Awareness", description: "Moving through Singapore's landmarks deepens appreciation for local heritage and diversity." },
      { icon: "Award", title: "Renewed Team Spirit", description: "Completing the race together gives the group a shared win to carry forward." },
    ],
    miniGallery: {
  ...
  "amongst-us": {
    ...
    testimonials: [
      ...
      { quote: "Everyone was suspicious of everyone else by round two. That tension created the best kind of team energy.", author: "Events Lead", company: "Ninja Van" },
      { quote: "The debrief at the end tied everything back to real team dynamics very naturally. Great for a learning-focused group.", author: "Organisation Development", company: "SingHealth" },
    ],
    faqs: [
    ...
    outcomes: [
      ...
      { icon: "Heart", title: "Deeper Mutual Trust", description: "Reading teammates and being read in return builds a more honest and open group dynamic." },
      { icon: "TrendingUp", title: "More Confident Communication", description: "Repeated rounds give participants practice speaking up, persuading, and defending their reasoning." },
    ],
    miniGallery: {
  ...
  "alice-in-motherland": {
    ...
    testimonials: [
      ...
      { quote: "Our quieter team members came out of their shells completely. The creative format gave everyone a reason to participate.", author: "Talent Manager", company: "Mediacorp" },
      { quote: "Alice in Motherland felt premium from start to finish. The theming and facilitation were both excellent.", author: "Corporate Events Lead", company: "Prudential Singapore" },
    ],
    faqs: [
    ...
    outcomes: [
      ...
      { icon: "Zap", title: "Increased Creative Confidence", description: "The playful format lowers hesitation and encourages people to try more imaginative solutions." },
      { icon: "Target", title: "Stronger Collective Focus", description: "Themed missions give the group a shared purpose that keeps energy directed and consistent." },
    ],
    miniGallery: {
  ...
  "battle-of-the-olympians": {
    ...
    testimonials: [
      ...
      { quote: "Our team was cheering for people they barely knew by the second round. The format builds collective energy fast.", author: "Regional HR", company: "Singapore Airlines" },
      { quote: "We needed something that worked for 200 people across very different functions. Battle of the Olympians was the right call.", author: "Head of Culture", company: "GovTech Singapore" },
    ],
    faqs: [
    ...
    outcomes: [
      ...
      { icon: "Heart", title: "Heightened Group Morale", description: "The tournament atmosphere gives everyone something to celebrate regardless of final standing." },
      { icon: "Lightbulb", title: "Better Role Clarity", description: "Competing across different event types helps participants understand where they add the most value." },
    ],
    miniGallery: {
  ...
  "archery-tag": {
    ...
    testimonials: [
      ...
      { quote: "The team roles made Archery Tag feel like more than a game. Even the planning phase got everyone talking.", author: "Learning & Development", company: "HSBC Singapore" },
      { quote: "Fast, safe, and genuinely well-structured. The competitive rounds had people cheering for each other by the end.", author: "HR Business Partner", company: "UOB Group" },
      { quote: "We expected it to be mostly physical but the strategy and coordination aspects were just as memorable.", author: "Employee Engagement", company: "Standard Chartered Singapore" },
    ],
    faqs: [],
    ...
    outcomes: [
      ...
      { icon: "Lightbulb", title: "Stronger Adaptive Thinking", description: "Rounds change quickly, pushing teams to re-plan on the fly rather than sticking to a single approach." },
      { icon: "Award", title: "Broader Group Contribution", description: "Different game modes mean more types of players get recognition across the session." },
    ],
    miniGallery: {
  ...
  "builder-cross": {
    ...
    outcomes: [
      ...
      { icon: "Zap", title: "Faster Iteration Habits", description: "The build-test-fix cycle teaches teams to move quickly without waiting for perfect conditions." },
      { icon: "Heart", title: "Shared Sense of Creation", description: "Having a physical result from the session gives the group something to connect around beyond just the activity." },
    ],
  ...
  "gel-blitz": {
    ...
    outcomes: [
      ...
      { icon: "Lightbulb", title: "Quicker Tactical Adaptation", description: "Each round forces teams to read what is not working and switch approaches fast." },
      { icon: "Award", title: "Boosted Group Morale", description: "Close matches and mission wins create a sustained sense of shared achievement across the session." },
    ],
  ...
  "minute-to-win-it": {
    ...
    outcomes: [
      ...
      { icon: "Target", title: "Sharper Time Awareness", description: "Working against 60-second countdowns sharpens urgency and focus in a low-stakes environment." },
      { icon: "Award", title: "Increased Group Confidence", description: "Small wins across multiple games help even quieter participants feel capable and valued." },
    ],
  ...
  "monopoly-dash": {
    ...
    outcomes: [
      ...
      { icon: "Award", title: "Richer Shared Discovery", description: "Teams come away knowing more about the city and each other from the combined race and trade experience." },
      { icon: "Zap", title: "Competitive Team Energy", description: "The trading layer keeps rivalry alive across the whole session rather than only at finish-line moments." },
    ],
  ...
  "nerfwar": {
    ...
    outcomes: [
      ...
      { icon: "Lightbulb", title: "Stronger Adaptive Instincts", description: "Changing battle modes push teams to rethink formations and redistribute effort quickly." },
      { icon: "Award", title: "Visible Individual Contributions", description: "Different roles within squads ensure most participants have a clear moment to shine." },
    ],
  ...
  "running-man": {
    ...
    outcomes: [
      ...
      { icon: "Target", title: "Sharper Reaction Speed", description: "Name-tag rounds and mission formats train participants to observe, respond, and commit quickly." },
      { icon: "Award", title: "Clear Team Recognition", description: "The tournament structure creates defined moments where individual and team contributions are celebrated." },
    ],
  ...
  "sotong-game": {
    ...
    outcomes: [
      ...
      { icon: "Lightbulb", title: "Stronger Group Awareness", description: "Elimination mechanics sharpen attention to detail and make participants more conscious of how they communicate." },
      { icon: "Award", title: "Rewarding Group Wins", description: "Surviving each round together gives teams frequent, visible moments to rally and celebrate." },
    ],
  ...
  "tag-tical-laser-teambuilding": {
    ...
    outcomes: [
      ...
      { icon: "Lightbulb", title: "Faster In-Game Adaptation", description: "Teams learn to reassign roles and adjust tactics mid-round rather than sticking to a single plan." },
      { icon: "Award", title: "Stronger Collective Momentum", description: "The technology and scoring format sustain group focus and energy well past the first few rounds." },
    ],
  ...
  "amazing-race-virtual": {
    ...
    faqs: [
      { question: "How does the Virtual Amazing Race work?", answer: "Teams compete through a series of online challenges, puzzles, and missions across virtual 'pit stops' — all facilitated live by our energetic host via Zoom or Teams." },
      { question: "What platform do we need?", answer: "All you need is Zoom or Microsoft Teams and a web browser. We handle the rest — no downloads or special software required." },
      { question: "How many people can participate?", answer: "We accommodate groups from 10 to 500+ participants, with teams of 4-6 working together in breakout rooms." },
      { question: "How long is the session?", answer: "The standard session runs 60-90 minutes, though we can customise the duration to fit your event schedule." },
    ],
  ...
  "fit-in-your-team-virtual": {
    ...
    faqs: [
      { question: "What kind of fitness activities are included?", answer: "Activities range from fun desk-friendly exercises to team-based fitness challenges — all designed for any fitness level and doable from home or office." },
      { question: "Do participants need equipment?", answer: "No equipment needed! All activities are bodyweight-based and can be done in a small space. We keep it accessible for everyone." },
      { question: "Can this be combined with other virtual activities?", answer: "Absolutely! Many clients pair Fit In Your Team with other virtual modules for a half-day or full-day programme." },
      { question: "How long does the session last?", answer: "Sessions typically run 45-75 minutes, including warm-up, team challenges, and a cool-down debrief." },
    ],
  ...
  "the-gameshow-experience-virtual": {
    ...
    faqs: [
      { question: "What format does the virtual gameshow follow?", answer: "Think TV-style gameshow — live host, buzzer rounds, trivia, and interactive challenges, all run through a custom digital platform with real-time scoring." },
      { question: "Can we customise the questions and rounds?", answer: "Yes! We can tailor rounds to include company trivia, industry topics, or themed content to match your event goals." },
      { question: "What's the ideal group size?", answer: "The gameshow works great for 10-300+ people. Teams of 4-6 compete in breakout rounds before the grand finale." },
      { question: "What tech setup is required?", answer: "Participants just need a computer with Zoom or Teams and a web browser for the interactive game elements. No app installs needed." },
    ],
  ...
  "the-great-zodiac-hunt-virtual": {
    ...
    faqs: [
      { question: "What is the Zodiac Hunt about?", answer: "Teams embark on a virtual adventure exploring Chinese zodiac lore, solving cultural puzzles, and completing missions that blend tradition with teamwork." },
      { question: "Is cultural knowledge required?", answer: "Not at all! Part of the fun is learning together. All clues and challenges are designed to be engaging for everyone regardless of background." },
      { question: "How are teams formed?", answer: "We split participants into teams of 4-6. You can pre-assign teams or let us randomise for maximum cross-department interaction." },
      { question: "When is the best time to run this?", answer: "While it's popular during Lunar New Year, the Zodiac Hunt works wonderfully year-round as a cultural appreciation team activity." },
    ],
  ...
  "the-nuclear-fallout-escape-room-virtual": {
    ...
    faqs: [
      { question: "How does the virtual escape room work?", answer: "Your team is placed in a high-stakes nuclear fallout scenario. You must solve puzzles, crack codes, and make critical decisions together via breakout rooms — all within a time limit." },
      { question: "How difficult is it?", answer: "We calibrate difficulty to your group. Whether it's a fun icebreaker or a serious problem-solving challenge, we adjust the complexity accordingly." },
      { question: "What happens if we don't escape in time?", answer: "The clock adds excitement but our facilitators guide teams to ensure everyone has a great experience — success rate is high with good teamwork!" },
      { question: "Can it be run for large groups?", answer: "Yes! Multiple teams can run the escape room simultaneously in parallel breakout rooms, with a shared leaderboard for added competition." },
    ],
  ...
  "the-patriot-act-virtual": {
    ...
    faqs: [
      { question: "What is The Patriot Act about?", answer: "Teams compete in Singapore-themed challenges covering local culture, history, food, and landmarks — perfect for celebrating National Day or onboarding expats." },
      { question: "Is this suitable for non-Singaporeans?", answer: "Absolutely! It's designed to be fun and educational for everyone. International teams love discovering Singapore's unique culture." },
      { question: "Can the content be customised?", answer: "Yes — we can weave in company values, team milestones, or specific cultural topics to make it more relevant to your group." },
      { question: "How long does the activity run?", answer: "Standard sessions run 60-90 minutes with an optional extended version for larger events or team days." },
    ],
  ...
  "tomb-raider-king-treasure-hunt-virtual": {
    ...
    faqs: [
      { question: "What is Tomb Raider King?", answer: "It's an epic virtual treasure hunt where teams decipher clues, navigate ancient puzzles, and race to collect the most gold — all in a cinematic adventure setting." },
      { question: "How competitive is it?", answer: "Very! Real-time scoreboards and timed challenges create intense but friendly competition. Teams strategise, delegate, and race against the clock." },
      { question: "What's the ideal group size?", answer: "Works great from 10 to 200+ participants. Teams of 4-6 compete simultaneously with live leaderboard updates." },
      { question: "Do you provide a facilitator?", answer: "Yes — a professional host guides the entire experience, keeps energy high, and manages all the tech so your team just focuses on the adventure." },
    ],
  ...
  "grand-christmas-delivery": {
    ...
    faqs: [
      { question: "What is Grand Christmas Delivery?", answer: "Teams work together on festive-themed missions to 'deliver' presents across a virtual world — combining Christmas cheer with strategic teamwork and hilarious challenges." },
      { question: "Is this only available in December?", answer: "While it's most popular during the holiday season, we can run adapted festive versions for year-end celebrations anytime in Q4." },
      { question: "Can we add a gift exchange element?", answer: "Yes! Many clients combine the virtual activity with a Secret Santa reveal or gift exchange segment for a complete Christmas party experience." },
      { question: "How festive does it get?", answer: "Very festive! Expect Christmas music, themed visuals, holiday costumes encouraged, and plenty of seasonal surprises built into the game." },
    ],
  ...
  "mass-talks": {
    ...
    testimonials: [
      ...
      { quote: "The speaker connected with every level of the organisation. From interns to directors, everyone was engaged.", author: "Rachel K.", company: "Deloitte Singapore" },
      { quote: "We've run 3 mass talks with Elluminate now. Each one better than the last.", author: "James T.", company: "OCBC Bank" },
      { quote: "The post-talk energy was incredible. Our teams were buzzing with ideas for weeks.", author: "Priya S.", company: "Unilever Singapore" },
    ],
    faqs: [
  ...
  "workshops": {
    ...
    testimonials: [
      ...
      { quote: "The facilitator adapted the workshop perfectly to our industry context. Felt tailor-made.", author: "Michelle L.", company: "CapitaLand Group" },
      { quote: "We saw measurable improvement in team collaboration within a month of the workshop.", author: "Andrew H.", company: "ST Engineering" },
      { quote: "Hands-down the most practical corporate training we've experienced. Zero fluff, all value.", author: "Wei Lin C.", company: "Singtel" },
    ],
    faqs: [
  ...
  "youth-camps": {
    ...
    testimonials: [
      ...
      { quote: "The way the facilitators connected with our teenagers was remarkable. Even the shy ones opened up.", author: "Mrs Tan S.", company: "Raffles Institution" },
      { quote: "Parents gave overwhelmingly positive feedback. The students learned real teamwork.", author: "Mr Ahmad R.", company: "Hwa Chong Institution" },
      { quote: "We've booked Elluminate for our orientation camp 3 years running. They just get it.", author: "Student Council Advisor", company: "NUS High School" },
    ],
    faqs: [
  ...
  "corporate-days": {
    ...
    testimonials: [
      ...
      { quote: "From registration to wrap-up, seamless execution. Our 200+ staff had the time of their lives.", author: "Denise F.", company: "Ernst & Young SG" },
      { quote: "The themed activities matched our company values perfectly. Felt like it was built just for us.", author: "Tommy W.", company: "FairPrice Group" },
      { quote: "Third year using Elluminate for our Corporate Day. The bar keeps getting higher!", author: "Siti N.", company: "Changi Airport Group" },
    ],
    faqs: [
