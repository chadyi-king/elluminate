...
export const servicesData: Record<string, ServiceData> = {
  ...
  "builder-cross": {
    ...
    overview: { description: "BuilderCross is a hands-on construction-style team building challenge where teams plan, build, and refine solutions together under time pressure.", backgroundImage: heroAdventureChallenge },
    ...
    howItWorksFlow: { sectionTitle: "WHAT TO EXPECT", sectionSubtitle: "Build Flow", itemsPerRow: 4, showNumbers: true, items: [{ icon: ClipboardList, title: "Challenge Briefing", description: "Receive your building challenge and materials." }, { icon: Building, title: "Plan & Design", description: "Strategize as a team." }, { icon: Puzzle, title: "Build & Test", description: "Construct and test under pressure." }, { icon: Trophy, title: "Final Showdown", description: "Compete in the ultimate build-off." }] },
  ...
  "gel-blitz": {
    ...
    howItWorksFlow: { sectionTitle: "WHAT TO EXPECT", sectionSubtitle: "Battle Flow", itemsPerRow: 3, showNumbers: true, items: [{ icon: ClipboardList, title: "Safety Briefing & Equip", description: "Learn the rules, get equipped with gel blasters." }, { icon: Target, title: "Tactical Rounds", description: "Compete in elimination and objective modes." }, { icon: Trophy, title: "Victory Celebration", description: "Final showdown and team awards." }] },
    perfectForFlow: defaultPerfectForFlow,
    clientLogos: ["Shopee"],
  ...
  "minute-to-win-it": {
    ...
    overview: { description: "Minute To Win It is a fast-paced series of short challenges where teams compete for points in quick one-minute rounds. Hundreds of games to choose from!", backgroundImage: heroTeamCelebration },
    ...
    howItWorksFlow: { sectionTitle: "WHAT TO EXPECT", sectionSubtitle: "Game Flow", itemsPerRow: 3, showNumbers: true, items: [{ icon: ClipboardList, title: "Game Briefing & Teams", description: "Form teams and learn the scoring rules." }, { icon: Timer, title: "Rapid-Fire Rounds", description: "Compete in one-minute challenges back-to-back." }, { icon: Trophy, title: "Final Showdown & Awards", description: "Crown the champions and celebrate together." }] },
    perfectForFlow: defaultPerfectForFlow,
    clientLogos: ["Grab"],
  ...
  "monopoly-dash": {
    ...
    overview: { description: "Monopoly Dash is a city-based strategy race inspired by Monopoly. Teams earn, trade, and complete missions across Singapore to gain an edge.", backgroundImage: heroAmazingRaceAlt },
    ...
    howItWorksFlow: { sectionTitle: "WHAT TO EXPECT", sectionSubtitle: "Dash Flow", itemsPerRow: 3, showNumbers: true, items: [{ icon: Map, title: "Explore Singapore Properties", description: "Navigate to real-life landmarks." }, { icon: Handshake, title: "Trade & Negotiate", description: "Strategize to maximize property value." }, { icon: Trophy, title: "Dominate & Win", description: "Claim the Monopoly crown." }] },
    perfectForFlow: defaultPerfectForFlow,
  ...
  "nerfwar": {
    ...
    hero: { title: "NERFWAR", subtitle: "Team Battle", tagline: "Action Packed and High Adrenaline!", backgroundImage: heroAdventureChallenge },
    overview: { description: "Action Packed and High Adrenaline! Nerfwar is an inclusive, high-energy team battle experience with safe foam blasters and structured match formats.", backgroundImage: heroAdventureChallenge },
    ...
    howItWorksFlow: { sectionTitle: "WHAT TO EXPECT", sectionSubtitle: "Battle Flow", itemsPerRow: 3, showNumbers: true, items: [{ icon: ClipboardList, title: "Safety Briefing & Equip", description: "Learn the rules and get Nerf blasters." }, { icon: Target, title: "Battle Rounds", description: "Compete in elimination and objective modes." }, { icon: Trophy, title: "Victory & Celebration", description: "Final showdown and awards." }] },
    perfectForFlow: defaultPerfectForFlow,
    clientLogos: ["Amazon"],
  ...
  "running-man": {
    accentColor: "#FFD400",
    dividerVariant: "route",
    hero: { title: "RUNNING MAN ADVENTURE", subtitle: "Team Games", tagline: "A fan favorite game made for all ages!", backgroundImage: heroCulturalRace },
    overview: { description: "Running Man Adventure is inspired by the hit variety show. Teams compete in hilarious missions, name-tag battles, and creative challenges that reward coordination and creativity.", backgroundImage: heroCulturalRace },
    ...
    howItWorksFlow: { sectionTitle: "WHAT TO EXPECT", sectionSubtitle: "Mission Flow", itemsPerRow: 3, showNumbers: true, items: [{ icon: ClipboardList, title: "Phase 1: Team Formation", description: "Form teams and receive your Running Man name tags." }, { icon: Gamepad2, title: "Phase 2: Variety Missions", description: "Compete in hilarious challenges inspired by the show." }, { icon: Trophy, title: "Phase 3: Final Showdown", description: "Name-tag battles and ultimate champion reveal." }] },
    perfectForFlow: defaultPerfectForFlow,
    clientLogos: ["Meta"],
    ...
    addOns: [{ icon: "UtensilsCrossed", title: "Food", description: "$8/pax" }, { icon: "Bus", title: "Transport", description: "$120/bus" }, { icon: "Medal", title: "Prizes", description: "$150" }, { icon: "MapPin", title: "Venue", description: "Depends on requirements" }, { icon: "Tag", title: "Name Tags", description: "$5/nametag" }],
  ...
  "sotong-game": {
    ...
    hero: { title: "SOTONG GAME", subtitle: "Squid-Style Games", tagline: "Building a team in the most 'Deadly' situation. Can your team survive?", backgroundImage: heroTeamCelebration },
    overview: { description: "Sotong Game is inspired by the tension and excitement of Squid-style games. Adapted into safe, team-friendly challenges that everyone can enjoy.", backgroundImage: heroTeamCelebration },
    ...
    howItWorksFlow: { sectionTitle: "WHAT TO EXPECT", sectionSubtitle: "Mission Flow", itemsPerRow: 4, showNumbers: true, items: [{ icon: ClipboardList, title: "Theme Introduction", description: "Enter the game world with themed briefing." }, { icon: Gamepad2, title: "Iconic Games", description: "Red Light Green Light, Dalgona, Tug of War, and more." }, { icon: Timer, title: "Elimination Rounds", description: "Compete through tense elimination challenges." }, { icon: Trophy, title: "Final Showdown", description: "Ultimate survivor reveal and celebration." }] },
    perfectForFlow: defaultPerfectForFlow,
    clientLogos: ["Grab"],
  ...
  "tag-tical-laser-teambuilding": {
    ...
    howItWorksFlow: { sectionTitle: "WHAT TO EXPECT", sectionSubtitle: "Battle Flow", itemsPerRow: 3, showNumbers: true, items: [{ icon: ClipboardList, title: "Safety Briefing & Equip", description: "Learn the rules and gear up with laser tag equipment." }, { icon: Target, title: "Tactical Rounds", description: "Compete in capture-the-flag and objective modes." }, { icon: Trophy, title: "Victory & Celebration", description: "Final showdown and team awards." }] },
    perfectForFlow: defaultPerfectForFlow,
    clientLogos: ["Shopee"],
    recentEvents: [{ client: "Shopee", event: "Laser Battle", pax: 140 }],
    pricing: { startingPrice: "From $45", unit: "per pax", minimumPax: 10, duration: "3 hours", activityType: "hybrid" },
    packages: trafficLightPackages("From $45/pax", "Tag-tical Laser Teambuilding", "#FFD400"),
    addOns: [{ icon: "UtensilsCrossed", title: "Food", description: "$8/pax" }, { icon: "Bus", title: "Transport", description: "$120/bus" }, { icon: "Medal", title: "Prizes", description: "$150" }, { icon: "MapPin", title: "Venue", description: "Depends on requirements" }],
