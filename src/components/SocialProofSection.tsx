...
// Split logos into groups of 8 for carousel
const logoGroups = [
  clientLogos.slice(0, 8),
  clientLogos.slice(8, 16),
  clientLogos.slice(16, 24),
];
  ...
  return (
    <section className="py-20 bg-background relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        {/* Logo Wall - Auto-scrolling Carousel */}
        <motion.div
        ...
        <motion.div
          ...
          className="mb-16"
        >
          <div className="relative bg-gradient-to-r from-primary/10 via-primary/15 to-primary/10 border border-primary/30 rounded-xl px-8 py-8 overflow-hidden">
            {/* Glow overlay */}
            ...
            <div className="relative z-10 flex flex-col items-center text-center">
                ...
                {[...Array(5)].map((_, i) => (
                  ...
                  >
                    <Star
                      ...
                      style={{
                        filter: "drop-shadow(0 0 8px hsl(43, 65%, 52%, 0.7))",
                      }}
                    />
                  </motion.div>
                ))}
              ...
              <div className="mb-2">
                <span className="text-3xl md:text-4xl font-serif text-metallic-gold font-bold">
                  4.8 / 5.0
                </span>
              </div>
              
              <p className="text-muted-foreground mb-1">
                Based on <span className="text-primary-soft font-medium">600+</span> Google Reviews
              </p>
