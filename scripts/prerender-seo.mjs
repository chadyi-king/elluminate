...
const services = {
  // Physical
  "team-building": { title: "Corporate Physical Team Building Singapore | Elluminate", description: "Plan corporate team bonding activities in Singapore around your pax, date, venue, and objective. Explore indoor, outdoor, and virtual team building options and request a quote." },
