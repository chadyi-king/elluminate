...
const services = {
  // Physical
  "team-building": { title: "Corporate Team Building Singapore | Elluminate", description: "Plan corporate team building in Singapore around your team, objective, venue and timing. Explore physical and virtual formats, then send Elluminate your event brief." },
