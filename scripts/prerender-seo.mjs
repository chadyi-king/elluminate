...
const services = {
  // Physical
  "team-building": { title: "Team Building Singapore - 3 Matched Options & Prices | Elluminate", description: "Skip the 50-activity catalogue. Tell us your headcount, date and venue, then request 3 best-fit team building options with prices from Elluminate." },
